...
**Privacy in Graph Learning:** Graph based learning methods, specifically graph neural networks (GNNs) are being applied in several domains including sensitive domains like medicine. It is important to ensure that such models do not inadvertantly leak any information about the data used to train such models. 
...
Privacy and explainability are fundamental in ensuring the trustworthiness of graph learning. However, achieving both of these objectives simultaneously can be challenging. In our recent research, we delve into the dynamic relationship between explainability and privacy in graph-based models, offering fresh insights and perspectives on this complex interplay.
